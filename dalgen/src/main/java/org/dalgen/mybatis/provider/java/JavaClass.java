...
import org.dalgen.mybatis.provider.java.JavaMethod.FieldMethodInvocation;
...
public class JavaClass {
  ...
  static String getClassName(String simpleJavaType) {
    return simpleJavaType.indexOf('$') >= 0
        ? simpleJavaType.substring(simpleJavaType.indexOf('$') + 1)
        : simpleJavaType;
  }
  ...
  public static class MavenHelper {
    public static String getMavenJavaTestSourceFile(String clazzFile) {
      ...
      clazzFile = clazzFile.replaceAll("\\w+\\$", ""); // for inner class User$1.class and
                                                       // User$Info.class
