...
import org.dalgen.mybatis.util.ListHashtable;

/**
 * @author Richard This class contains a list of all the tables for which foreign keys exist for the
 *         containing SqlTable. It contains a reference to the parent and also a Hashtable of
