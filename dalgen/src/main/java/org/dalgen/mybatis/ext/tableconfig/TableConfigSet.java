...
import org.dalgen.mybatis.provider.db.table.TableFactoryListener;
...
public class TableConfigSet implements Iterable<TableConfig>, TableFactoryListener {
  ...
  public TableConfig getRequiredBySqlName(String sqlName) {
    ...
    if (tc == null) {
      throw new IllegalArgumentException(
          "not found TableConfig on TableConfigSet by sqlName:" + sqlName);
    }
    return tc;
  }
  ...
  protected void finalize() throws Throwable {
    super.finalize();
    log.warn("没有手工清除TableFactoryListener for TableConfigSet");
