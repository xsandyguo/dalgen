 ...
 * resources in a uniform manner. {@link org.springframework.core.io.ResourceLoader}'s <code>
 * getResource</code> method can resolve any location to a
 * {@link org.springframework.core.io.Resource} object, which in turn allows to obtain a
 * <code>java.io.File
 * </code> in the file system through its <code>getFile()</code> method.
 *
 * <p>
 ...
 * system has been initialized</i>. Spring' Resource abstraction in the core package, on the other
 * hand, already expects the logging system to be available.
 *
...
public abstract class ResourceHelper {
  ...
  /**
   * Resolve the given resource location to a <code>java.io.File</code>, i.e. to a file in the file
   * system.
   *
   * <p>
   * Does not check whether the fil actually exists; simply returns the File that the given location
   * would correspond to.
   *
   * @param resourceLocation the resource location to resolve: either a "classpath:" pseudo URL, a
   *        "file:" URL, or a plain file path
  ...
  /**
   * Resolve the given resource URI to a <code>java.io.File</code>, i.e. to a file in the file
   * system.
   *
   ...
   *
   * <p>
   * "zip" and "wsjar" are used by BEA WebLogic Server and IBM WebSphere, respectively, but can be
   * treated like jar files. The same applies to "code-source" URLs on Oracle OC4J, provided that
  ...
  public static boolean isJarURL(URL url) {
    ...
    return (URL_PROTOCOL_JAR.equals(protocol) || URL_PROTOCOL_ZIP.equals(protocol)
        || URL_PROTOCOL_WSJAR.equals(protocol) || (URL_PROTOCOL_CODE_SOURCE.equals(protocol)
            && url.getPath().contains(JAR_URL_SEPARATOR)));
  }
