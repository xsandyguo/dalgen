...
public class AntPathMatcher {
   ...
   *
   * <p>
   * Assumes that {@link #match} returns <code>true</code> for '<code>pattern</code>' and '<code>
   ...
   * file extension match (such as {@code *.html}. In that case, the second pattern should be
   ...
   *
   * <ol>
   * <li><code>/hotels/new</code>
   * <li><code>/hotels/{hotel}</code>
   * <li><code>/hotels/*</code>
   * </ol>
   *
