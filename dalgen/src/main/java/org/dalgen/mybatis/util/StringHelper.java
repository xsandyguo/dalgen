...
import org.dalgen.mybatis.provider.db.table.EnumMetaDada;
...
public class StringHelper {
   ...
   * @return a new String consisting of the original String repeated, <code>null</code> if null
   *         String input
   * @since 2.5
   */
  ...
  public static String toJavaClassName(String sqlName) {
    return toJavaClassName(sqlName,
        GeneratorProperties.getBoolean(GeneratorConstants.TABLE_NAME_SINGULARIZE));
  }
  ...
  public static String removeIbatisOrderBy(String sql) {
    ...
    return removeXmlTagIfBodyEmpty(removeXmlTagIfBodyEmpty(
        removeXmlTagIfBodyEmpty(removeXmlTagIfBodyEmpty(orderByRemovedSql))));
  }
  ...
  public static String insertTokenIntoSelectSql(String str, String insertValue) {
    ...
    return new StringBuffer(str).insert(selectBeginPos + "select ".length(), insertValue)
        .toString();
  }
  ...
  public static String columnNameToClassName(String dbName) {
    ...
    // return
    // StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(dbName));
  }
