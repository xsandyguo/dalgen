...
public class BeanHelper {
    ...
    for (String key : keys) {
      ...
      if (pd == null) {
        throw new IllegalArgumentException(
            "not found property:'" + key + "' on class:" + target.getClass());
      }
        ...
        try {
          if (source instanceof Map) {
            ...
            PropertyDescriptor sourcePd =
                getPropertyDescriptor(source.getClass(), targetPd.getName(), ignoreCase);
  ...
  public static void setProperty(Object target, String propertyName, Object value) {
    ...
    if (pd == null) {
      throw new IllegalArgumentException(
          "not found property:" + propertyName + " on class:" + target.getClass());
    }
  ...
  private static void setProperty(Object target, PropertyDescriptor propertyDescriptor,
      Object value) {
    ...
    if (writeMethod == null) {
      throw new IllegalArgumentException("not found write method for property:"
          + propertyDescriptor.getName() + " on class:" + target.getClass());
    }
    ...
    try {
      ...
      throw new RuntimeException(
          "error set property:" + propertyDescriptor.getName() + " on class:" + target.getClass(),
          e);
    }
  }
  ...
  private static Object convert(String value, Class<?> targetType) {
    ...
    throw new IllegalArgumentException(
        "cannot convert value:" + value + " to targetType:" + targetType);
  }
