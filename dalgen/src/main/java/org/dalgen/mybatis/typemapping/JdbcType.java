...
public enum JdbcType {
  BIT(Types.BIT), TINYINT(Types.TINYINT), SMALLINT(Types.SMALLINT), INTEGER(Types.INTEGER), BIGINT(
      Types.BIGINT), FLOAT(Types.FLOAT), REAL(
          Types.REAL), DOUBLE(Types.DOUBLE), NUMERIC(Types.NUMERIC), DECIMAL(Types.DECIMAL),
  ...
  BINARY(Types.BINARY), VARBINARY(Types.VARBINARY), LONGVARBINARY(Types.LONGVARBINARY),

  BOOLEAN(Types.BOOLEAN),

  BLOB(Types.BLOB), CLOB(Types.CLOB),

  NULL(Types.NULL), OTHER(Types.OTHER), CURSOR(-10), // Oracle
  UNDEFINED(Integer.MIN_VALUE + 1000),

  ROWID(-8), NVARCHAR(-9), NCHAR(-15), LONGNVARCHAR(-16), SQLXML(2009), NCLOB(2011);
