...
public class ParsedSql {
   ...
   */
  public void addNamedParameter(String parameterName, String parameterPlaceholder, int startIndex,
      int endIndex) {
  ...
  /**
   * Return all of the parameters (bind variables) in the parsed SQL statement. Repeated occurences
   ...
   * repeated occurences do not count here.
   */
  ...
  /**
   * Return the total count of all of the parameters in the SQL statement. Repeated occurences of
  ...
  /**
   * Set the total count of all of the parameters in the SQL statement. Repeated occurences of the
