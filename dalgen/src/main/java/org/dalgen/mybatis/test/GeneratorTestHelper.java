package org.dalgen.mybatis.test;
...
import org.dalgen.mybatis.generator.Generator;
import org.dalgen.mybatis.generator.GeneratorFacade;
import org.dalgen.mybatis.generator.GeneratorModel;
...
public class GeneratorTestHelper {
  ...
  public static String generateBy(GeneratorFacade gf, GeneratorModel... models) throws Exception {
  ...
  private static File getOutputTempDir() {
    File tempDir = new File(FileHelper.getTempDir(),
        "GeneratorTestHelper/" + count.incrementAndGet() + ".tmp");
